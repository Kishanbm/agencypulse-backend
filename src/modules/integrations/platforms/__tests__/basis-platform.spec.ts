...
import { BasisApiService } from '../basis-api.service';
import fixture from '../__fixtures__/basis-platform.fixture.json';

const dateRange = { from: '2024-01-15', to: '2024-01-21' };

describe('BasisApiService', () => {
  let service: BasisApiService;

  beforeEach(() => {
    service = new BasisApiService();
    clearFetchMocks();
  });
